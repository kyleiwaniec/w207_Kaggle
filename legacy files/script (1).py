...
print("all_lr", log_loss(labels, lrmodel.predict_proba(features.as_matrix())))
print("train_lr", log_loss(labels_train, lrmodel.predict_proba(features_train.as_matrix())))
print("test_lr", log_loss(labels_test, lrmodel.predict_proba(features_test.as_matrix())))
...
import gzip
with gzip.GzipFile('submission_org.csv.gz',mode='w',compresslevel=9) as gzfile:
